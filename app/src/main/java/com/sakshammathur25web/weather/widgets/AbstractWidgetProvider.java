package com.sakshammathur25web.weather.widgets;
...
public abstract class AbstractWidgetProvider extends AppWidgetProvider {
    ...
    Bitmap getWeatherIcon(String text, Context context) {
    ...
    private String localize(SharedPreferences sp, Context context, String preferenceKey,
