package com.sakshammathur25web.weather.adapters;
...
import com.sakshammathur25web.weather.models.WeatherViewHolder;
...
public class WeatherRecyclerAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<WeatherViewHolder> {
    ...
    public WeatherViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        @SuppressLint("InflateParams") View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_row, null);
    ...
    public void onBindViewHolder(@NonNull WeatherViewHolder customViewHolder, int i) {
        ...
        String defaultDateFormat = context.getResources().getStringArray(R.array.dateFormatValues)[0];
        ...
        String dateString;
        try {
            @SuppressLint("SimpleDateFormat") SimpleDateFormat resultFormat = new SimpleDateFormat(dateFormat);
